  ...
  setTimeout(() => createCarousel('playlist-carousel', 'playlist-info', 'playlist-dots', [
    {
      title: 'Classic',
      subtitle: 'Playlist',
      url: 'https://music.apple.com/es/playlist/classic/pl.u-JPAZED2FWvJ4Dx?l=en',
      gradient: ['#053B3A', '#2CB0A8'],
      cover: 'Classic.jpg',
    },
    {
      title: 'Authentic',
      subtitle: 'Playlist',
      url: 'https://music.apple.com/es/playlist/authentic/pl.u-aZb00D4IVgzePE?l=en',
      gradient: ['#0F2120', '#CCD4FD'],
      cover: 'Authentic.jpg',
    },
    {
      title: 'Combustible',
      subtitle: 'Playlist',
      url: 'https://music.apple.com/es/playlist/combustible/pl.u-JPAZBW9CWvJ4Dx?l=en',
      gradient: ['#2CB0A8', '#FAFFAF'],
      cover: 'Combustible.jpg',
    },
    {
      title: 'Dream',
      subtitle: 'Playlist',
      url: 'https://music.apple.com/es/playlist/dream/pl.u-JPAZB4GTWvJ4Dx?l=en',
    ...
    },
    {
      title: 'Tripin21',
      subtitle: 'Playlist',
      url: 'https://music.apple.com/es/playlist/tripin21/pl.u-38oW9PWCg1q2Py?l=en',
    ...
    },
    {
      title: 'Lines',
      subtitle: 'Playlist',
      url: 'https://music.apple.com/es/playlist/lines/pl.u-aZb0YA0CVgzePE?l=en',
    ...
    },
    {
      title: 'Clásico 2.0',
      subtitle: 'Playlist',
      url: 'https://music.apple.com/es/playlist/cl%C3%A1sico-2-0/pl.u-11zBv2VcZGje80?l=en',
      gradient: ['#2CB0A8', '#CCD4FD'],
      cover: 'Clasico 2.0.jpg',
    },
    {
      title: 'Trip',
      subtitle: 'Playlist',
      url: 'https://music.apple.com/es/playlist/trip/pl.u-aZb0Yq6uVgzePE?l=en',
      gradient: ['#0F2120', '#2CB0A8'],
      cover: 'Trip.jpg',
    },
    {
      title: 'Melancholy',
      subtitle: 'Playlist',
      url: 'https://music.apple.com/es/playlist/melancholy/pl.u-mJy88g8sBKl3zZ?l=en',
      gradient: ['#053B3A', '#CCD4FD'],
      cover: 'Melancholy.jpg',
    },
    {
      title: 'Doomed',
      subtitle: 'Playlist',
      url: 'https://music.apple.com/es/playlist/doomed/pl.u-aZb0aVZuVgzePE?l=en',
      gradient: ['#121417', '#053B3A'],
      cover: 'Doomed.jpg',
    },
    {
      title: 'Cocktails 2.0',
      subtitle: 'Playlist',
      url: 'https://music.apple.com/es/playlist/cocktails-2-0/pl.u-76oNPbbTNmZlW3?l=en',
      gradient: ['#2CB0A8', '#FAFFAF'],
      cover: 'Cocktails 2.0.jpg',
    },
    {
      title: 'Russian Soul',
      subtitle: 'Playlist',
      url: 'https://music.apple.com/es/playlist/russian-soul-mix/pl.u-V9D77GEU10PrBY?l=en',
      gradient: ['#CCD4FD', '#053B3A'],
      cover: 'Russian Soul.jpg',
    },
  ]), 800);
});
